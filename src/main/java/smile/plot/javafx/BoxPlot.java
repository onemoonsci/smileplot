...
public class BoxPlot extends Plot {
    ...
    @Override
    public SmileFxCanvas canvas() {
        double[] lowerBound = getLowerBound();
        double[] upperBound = getUpperBound();

        SmileFxCanvas canvas = new SmileFxCanvas(lowerBound, upperBound);
        canvas.add(this);
     ...
     * @param data a data matrix of which each row will create a box plot.
     */
    public static BoxPlot of(double[][] data, String[] labels) {
        return new BoxPlot(data, labels);
    }
}
