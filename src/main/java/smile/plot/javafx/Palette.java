...
public class Palette {
    ...
    public static final Color SLATE_GRAY = Color.web("0X708090");
    public static final Color LIGHT_SLATE_GRAY = Color.LIGHTSLATEGRAY;
    public static final Color DARK_SLATE_GRAY = Color.DARKSLATEGRAY;
    public static final Color RED = Color.RED;
    public static final Color DARK_RED = Color.DARKRED;
    public static final Color VIOLET_RED =  Color.web("0XF6358A");
    public static final Color GREEN = Color.GREEN;
    public static final Color DARK_GREEN = Color.DARKGREEN;
    public static final Color LIGHT_GREEN = Color.LIGHTGREEN;
    public static final Color PASTEL_GREEN = Color.web("0X00FF00");
    public static final Color FOREST_GREEN = Color.FORESTGREEN;
    public static final Color GRASS_GREEN = Color.web("0X408080");
    public static final Color BLUE = Color.BLUE;
    public static final Color NAVY_BLUE = Color.web("0X000080");
    public static final Color SLATE_BLUE = Color.web("0X6A5ACD");
    public static final Color ROYAL_BLUE = Color.web("0X2B60DE");
    public static final Color CADET_BLUE = Color.web("0X4C787E");
    public static final Color MIDNIGHT_BLUE = Color.MIDNIGHTBLUE;
    public static final Color SKY_BLUE = Color.SKYBLUE;
    public static final Color STEEL_BLUE = Color.STEELBLUE;
    public static final Color DARK_BLUE = Color.DARKBLUE;
    public static final Color MAGENTA = Color.MAGENTA;
    public static final Color DARK_MAGENTA = Color.DARKMAGENTA;
    public static final Color CYAN = Color.CYAN;
    public static final Color DARK_CYAN = Color.DARKCYAN;
    public static final Color PURPLE = Color.PURPLE;
    public static final Color LIGHT_PURPLE = Color.web("0XFF0080");
    public static final Color DARK_PURPLE = Color.web("0X800080");
    public static final Color ORANGE = Color.ORANGE;
    public static final Color PINK = Color.PINK;
    public static final Color YELLOW = Color.YELLOW;
    public static final Color GOLD = Color.GOLD;
    public static final Color BROWN = Color.BROWN;
    public static final Color SALMON = Color.SALMON;
    public static final Color TURQUOISE = Color.TURQUOISE;
    public static final Color BURGUNDY = Color.web("0X800000");
    public static final Color PLUM = Color.web("0XB93B8F");
