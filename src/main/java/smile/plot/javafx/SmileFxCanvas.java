...
public class SmileFxCanvas {
     ...
     */
    private static final Font DEFAULT_TITLE_FONT = new Font("Arial", 16);
    /**
     ...
     * Constructor
     */
    public SmileFxCanvas(double[] lowerBound, double[] upperBound) {
     ...
     * Constructor
     */
    public SmileFxCanvas(double[] lowerBound, double[] upperBound, boolean extendBound) {
...
//    }
     ...
     */
    public SmileFxCanvas setLegendVisible(boolean visible) {
        isLegendVisible = visible;
        return this;
    }

    /**
     * Returns the size of margin, which is not used as plot area. Currently,
     * all four sides have the same margin size.
     *
     ...
     */
    public SmileFxCanvas setMargin(double margin) {
     ...
     */
    public SmileFxCanvas setTitle(String title) {
     ...
     */
    public SmileFxCanvas setTitleFont(Font font) {
     ...
     */
    public SmileFxCanvas setTitleColor(Color color) {
     ...
     */
    public SmileFxCanvas setAxisLabels(String... labels) {
     ...
     */
    public SmileFxCanvas setAxisLabel(int i, String label) {
     ...
     * Paints the canvas.
     */
    public void paint(GraphicsContextInterface g2d, int width, int height) {
        ...
        if (isLegendVisible) {
            ...
            int fontWidth = (int) font.getSize();
            int fontHeight = (int) font.getSize();
                ...
                if (s instanceof Plot) {
                    ...
                    if (p.legends().isPresent()) {
                        for (Legend legend : p.legends().get()) {
                            g2d.setFill(legend.color);
                            g2d.setStroke(legend.color);
                            g2d.fillRect(x, y, fontWidth, fontHeight);
                            g2d.strokeRect(x, y, fontWidth, fontHeight);
                            g2d.fillText(legend.text, x + 2 * fontWidth, y + fontHeight);
                            y += 2 * fontWidth;
                        }
                    }
                }
        ...
        if (title != null) {
            ...
            g2d.setFill(titleColor);
            g2d.setStroke(titleColor);
            int textWidth = (int) getTextWidth(title, titleFont);
            int x = (width - textWidth) / 2;
            int y = (int) (height * margin) / 2;
            g2d.fillText(title, x, y);
        }
    }
